...
var config = {
  apiOrigins: {
    ...
    production: 'https://gotreads.herokuapp.com'
  }
};
...
var booksEvents = __webpack_require__(16);
...
var onCreateBook = function onCreateBook(event) {
  ...
  api.createBook(data).then(ui.createBookSuccess).catch(ui.createBookFailure);
};

var onGetAllBooks = function onGetAllBooks(event) {
  event.preventDefault();
  // const data = getFormFields(event.target)
  // console.log('onGetAllBooks events function reached!')
  api.getBooks().then(ui.getBookSuccess).catch(ui.getBookFailure);
};
...
var onDeleteBook = function onDeleteBook(event) {
  ...
  api.deleteBook(id.book.id).then(ui.onDeleteBookSuccess).catch(ui.onDeleteBookFailure);
};
...
var onUpdateBook = function onUpdateBook(event) {
  ...
  .then(ui.onUpdateBookSuccess).catch(ui.onUpdateBookFailure);
};
...
var showBooksTemplate = __webpack_require__(19);
...
var createBookFailure = function createBookFailure(response) {
  $('#message').text('Adding a book failed. Try again.');
};

var getBookSuccess = function getBookSuccess(data) {
  ...
  if (data.books == '') {
    ...
    var showBookList = showBooksTemplate({ books: data.books });
    $('#book-listing').empty();
    $('#book-listing').show();
...
var getBookFailure = function getBookFailure(response) {
  $('#message').text('Oh, snap, getting some books failed. Try again.');
};

var onDeleteBookSuccess = function onDeleteBookSuccess(id) {
...
var onDeleteBookFailure = function onDeleteBookFailure(response) {
...
var onUpdateBookSuccess = function onUpdateBookSuccess(id) {
...
var onUpdateBookFailure = function onUpdateBookFailure(response) {
...
module.exports = {
  ...
  onDeleteBookSuccess: onDeleteBookSuccess,
  onDeleteBookFailure: onDeleteBookFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<ul id=\"book-listing\" data-id=\""
    ...
    + "</li>\n  <li>Status: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.newstatus : stack1), depth0))
    + "</li>\n</ul>\n";
